# Prompt 2: Agente Planejador e Refinamento

**Objetivo:** Prompt utilizado para gerar o plano de estudos de 90 dias, seguido do comando de refinamento para adequar o escopo do projeto e versionamento.

---

## 🤖 1. Prompt Base Utilizado (Agente 2)
...
## 🎯 2. Refinamento Adicional (Fine-tuning)

Após a geração do plano inicial, apliquei o seguinte prompt para melhorar a aderência ao mercado:

**Prompt:**
"quero você adicione nas primeiras semanas o git e github, e faça outra projeto de portfólio, algo que chame mais atenção das empresas"
